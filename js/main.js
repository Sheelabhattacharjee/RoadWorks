...
jQuery(document).ready(function($){
	...
	if($("#map").length && typeof(google)!="undefined")
	{
		...
		var mapOptions = {
			...
			styles: [ { "featureType": "water", "elementType": "geometry", "stylers": [ { "color": "#8ccaf1" } ] },{ "featureType": "poi", "stylers": [ { "visibility": "off" } ] },{ "featureType": "transit", "stylers": [ { "visibility": "off" } ] },{ "featureType": "water", "elementType": "labels", "stylers": [ { "color": "var(--text-color)fff" }, { "visibility": "simplified" } ] } ]
		};
